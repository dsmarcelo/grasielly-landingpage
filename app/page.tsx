  ...
  return (
    <div className="min-h-screen mx-auto flex flex-col justify-center items-center">
      <div className="w-full relative flex justify-center">
        <div className="w-full dark-gradient">
          <div className="mx-auto flex flex-col justify-center items-center px-4 md:px-10 lg:px-20 max-w-7xl">
      ...
      <div className="px-4 md:px-10 lg:px-20 max-w-7xl">
        ...
        <section className="w-full mb-20 flex flex-col items-center gap-12">
          <h2 className="">ENTENDA O GOLPE DO PIX:</h2>
          <div className="grid grid-cols-1 grid-rows-2 md:grid-cols-2 gap-12 md:grid-rows-1 ">

            <div className="p-normal md:text-base">
              <p className="">
